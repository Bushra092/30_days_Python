...
def complete_todo(position: int):
    with conn:
        c.execute('UPDATE todos SET status = 2, date_completed = date_completed WHERE position = :positions', {'position': position, 'delete_completed': datetime.datetime.now().isoformat()})